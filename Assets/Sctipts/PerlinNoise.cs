    ...
    void UpdateTexture(System.Func<float, float, float, float> generator)
    {
        ...
        for (var y = 0; y < size; y++)
        {
            for (var x = 0; x < size; x++)
            {
                ...
                Color c = Color.white * (n / 1.4f + 0.5f);
                texture.SetPixel(x, y,new Color(c.r,c.g,c.b,1));
            }
        }
        ...
        try
        {
            ...
            FileStream stream = new FileStream(Application.dataPath + "/PerlinNoise.jpg", FileMode.Create, FileAccess.ReadWrite);
